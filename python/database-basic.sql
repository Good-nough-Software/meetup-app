...
insert into locations (country, state, city, zip, address) 
	values ('United States', 'Michigan', 'Houghton', '49931')

insert into locations (country, state, city, zip, address) 
	values ('United States', 'Michigan', 'Traverse City', '49643')

insert into locations (country, state, city, zip, address) 
	values ('United States', 'Michigan', 'Ann Arbor', '48110')

insert into locations (country, state, city, zip, address) 
	values ('United States', 'Pennsylvania', 'Philadelphia', '19019')

update users 
	set location = (select id from location where zip='49931')
...
update users 
	set location = (select id from location where zip='48810')
where email = 'mdock@gmail.com'
update users 
	set location = (select id from location where zip='49643')
...
insert into relations (eventid, userid) values ((select id from users where email='jmarek@mtu.edu'), (select id from events where id > 0))

insert into relations (eventid, userid) values ((select id from users where email='jdoe@gmail.com'), (select id from events where id > 0))
